...
public class SelectionExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andStudentIdLike(Long value) {
            addCriterion("student_id like", value, "studentId");
            return (Criteria) this;
        }

        public Criteria andStudentIdNotLike(Long value) {
        ...
        public Criteria andCourseIdLike(Long value) {
            addCriterion("course_id like", value, "courseId");
            return (Criteria) this;
        }

        public Criteria andCourseIdNotLike(Long value) {
        ...
        public Criteria andUpdateTimeNotBetween(Date value1, Date value2) {
		 ...
		 public Criteria andLikeQuery(Selection record) {
			...
			if(record.getCourseId()!=null&&StrUtil.isNotEmpty(record.getCourseId().toString())) {
    			 list.add("ifnull(course_id,'')");
    		}
			...
			if(record.getDeleted()!=null&&StrUtil.isNotEmpty(record.getDeleted().toString())) {
    			 list.add("ifnull(deleted,'')");
    		}
