...
public class CourseNumExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andAllowanceLike(Integer value) {
            addCriterion("allowance like", value, "allowance");
            return (Criteria) this;
        }

        public Criteria andAllowanceNotLike(Integer value) {
        ...
        public Criteria andUpdateTimeNotBetween(Date value1, Date value2) {
		 ...
		 public Criteria andLikeQuery(CourseNum record) {
			...
			if(record.getAllowance()!=null&&StrUtil.isNotEmpty(record.getAllowance().toString())) {
    			 list.add("ifnull(allowance,'')");
    		}
