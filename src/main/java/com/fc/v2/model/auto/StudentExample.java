...
public class StudentExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andClazzLike(Integer value) {
            addCriterion("clazz like", value, "clazz");
            return (Criteria) this;
        }

        public Criteria andClazzNotLike(Integer value) {
        ...
        public Criteria andUpdateTimeNotBetween(Date value1, Date value2) {
		 ...
		 public Criteria andLikeQuery(Student record) {
			...
			if(record.getClazz()!=null&&StrUtil.isNotEmpty(record.getClazz().toString())) {
    			 list.add("ifnull(clazz,'')");
    		}
			...
			if(record.getLastLoginTime()!=null&&StrUtil.isNotEmpty(record.getLastLoginTime().toString())) {
    			 list.add("ifnull(last_login_time,'')");
    		}
			if(record.getLastLoginIp()!=null&&StrUtil.isNotEmpty(record.getLastLoginIp().toString())) {
    			 list.add("ifnull(last_login_ip,'')");
    		}
			...
			if(record.getLastLoginTime()!=null&&StrUtil.isNotEmpty(record.getLastLoginTime().toString())) {
    			list2.add("'%"+record.getLastLoginTime()+"%'");
    		}
			if(record.getLastLoginIp()!=null&&StrUtil.isNotEmpty(record.getLastLoginIp().toString())) {
    			list2.add("'%"+record.getLastLoginIp()+"%'");
    		}
			if(record.getDeleted()!=null&&StrUtil.isNotEmpty(record.getDeleted().toString())) {
