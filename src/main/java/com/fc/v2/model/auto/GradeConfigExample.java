 ...
 */
public class GradeConfigExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andUpdateTimeNotBetween(Date value1, Date value2) {
		 ...
		 public Criteria andLikeQuery(GradeConfig record) {
			...
			if(record.getTitel()!=null&&StrUtil.isNotEmpty(record.getTitel().toString())) {
    			 list.add("ifnull(titel,'')");
    		}
			if(record.getDescription()!=null&&StrUtil.isNotEmpty(record.getDescription().toString())) {
    			 list.add("ifnull(description,'')");
    		}
			if(record.getBeginTime()!=null&&StrUtil.isNotEmpty(record.getBeginTime().toString())) {
    			 list.add("ifnull(begin_time,'')");
    		}
			if(record.getEndTime()!=null&&StrUtil.isNotEmpty(record.getEndTime().toString())) {
    			 list.add("ifnull(end_time,'')");
    		}
			...
			if(record.getTitel()!=null&&StrUtil.isNotEmpty(record.getTitel().toString())) {
    			list2.add("'%"+record.getTitel()+"%'");
    		}
			if(record.getDescription()!=null&&StrUtil.isNotEmpty(record.getDescription().toString())) {
    			list2.add("'%"+record.getDescription()+"%'");
    		}
			if(record.getBeginTime()!=null&&StrUtil.isNotEmpty(record.getBeginTime().toString())) {
    			list2.add("'%"+record.getBeginTime()+"%'");
    		}
			if(record.getEndTime()!=null&&StrUtil.isNotEmpty(record.getEndTime().toString())) {
